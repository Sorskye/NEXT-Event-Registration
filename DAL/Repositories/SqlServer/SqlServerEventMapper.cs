    ...
    internal static class SqlServerEventMapper
    {
        ...
        internal static Event ReadEvent(SqlDataReader reader)
        {
            ...
            return new Event
            {
                ...
                Photo = photo,
                Beginning_date = reader["Beginning_date"] == DBNull.Value ? null : DateOnly.FromDateTime(Convert.ToDateTime(reader["Beginning_date"])),
                Ending_date    = reader["Ending_date"]    == DBNull.Value ? null : DateOnly.FromDateTime(Convert.ToDateTime(reader["Ending_date"])),
                Beginning_time = reader["Beginning_time"] == DBNull.Value ? null : TimeOnly.FromTimeSpan((TimeSpan)reader["Beginning_time"]),
                Ending_time    = reader["Ending_time"]    == DBNull.Value ? null : TimeOnly.FromTimeSpan((TimeSpan)reader["Ending_time"]),
